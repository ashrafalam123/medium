...
export const BlogCard = ({
    ...
    <div className="p-4 border-b border-slate-200 pb-4 hover:cursor-pointer">
        <div className="flex justify-start">
            <div className="flex justify-center flex-col">
                <Avatar size = "small" name={authorName} />
            </div>
            <div className="flex justify-center flex-col font-extralight text-sm pl-2">
                {authorName} 
            </div>
            <div className="flex justify-center flex-col pl-2">
                <Circle />
            </div>
            <div className="flex justify-center flex-col font-thin pl-2 text-sm text-slate-500">
                {publishedDate}
            </div>
        </div>
